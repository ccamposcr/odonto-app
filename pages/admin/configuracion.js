...
export default function ConfiguracionAdmin() {
  ...
  const handleMedicalDragEnd = async (event) => {
              ...
              <div className="bg-white rounded-lg shadow p-4 sm:p-6">
                ...
                <form onSubmit={handleMedicalSubmit} className="mb-6 sm:mb-8 p-3 sm:p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3 mt-4">
                    ...
                    {editingField && (
                      <button type="button" onClick={resetMedicalForm} className="btn btn-secondary">
                        Cancelar
                      </button>
                    )}
                  </div>
                ...
                <div className="overflow-x-auto">
                  <DndContext 
                    ...
                    onDragEnd={handleMedicalDragEnd}
                  >
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-dental-teal text-white">
                        ...
                        >
                          {medicalFields && medicalFields.map((field) => (
                            <SortableTableRow 
                              key={field.id}
                              field={field}
                              editField={editMedicalField}
                              deleteField={deleteMedicalField}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="relative">
                      ...
                      <div className="relative">
                        ...
                        {showCategorySuggestions && getFilteredCategories() && getFilteredCategories().length > 0 && (
                        ...
                        {showCategorySuggestions && !treatmentFormData.category && getUniqueCategories() && getUniqueCategories().length > 0 && (
                          <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-40 overflow-y-auto">
